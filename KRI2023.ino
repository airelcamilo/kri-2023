...
void jalan(){
    ...
    Leg(0, normalFootHeight-20, tiltOffset-5, rotasiKaki+10, tegak+8, angleRight,0); //-35
    Leg(0, normalFootHeight - 40, -tiltOffset-5, -rotasiKaki-10, tegak+8, angleLeft,1); //-65
    moveOn(delayTime+40); 
}
